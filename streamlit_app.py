...
st.set_page_config(
    page_title="E2E BY XMARTY ARYAN KING",
    page_icon="",
    layout="wide",
...
ADMIN_PASSWORD = "XMARTY_ARYAN_KING"
...
def send_whatsapp_message(user_name, approval_key):
    message = f" HELLO XMARTY ARYAN KING SIR PLEASE \nMy name is {user_name}\nPlease approve my key:\n {approval_key}"
...
def login_page():
    ...
    <div class="main-header">
        <img src="https://i.ibb.co/5W1QW4zH/1753900515862.jpg" class="prince-logo">
        <h1>XMARTY ARYAM KING OFFLINE E2EE </h1>
...
st.markdown('<div class="footer">Made with  by Xmarty Aryan King | � 2025</div>', unsafe_allow_html=True)
